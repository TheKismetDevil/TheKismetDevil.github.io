if (!self._FC2COUNTER31741831_1)
{
	var _FC2COUNTER31741831_1 =
	{
		id:31741831,
		graph_img:null,
		show_graph:function(e)
		{
			if (this.graph_img == null )
			{
				...
				img.src = 'http://panel.counter1.fc2.com/popup.php?id=31741831&main=1&lang=0';
		...
		disp_js:function()
		{
			document.write('<script type="text/javascript" language="javascript"'
				+ ' src="http://counter1.fc2.com/counter_js.php?id=31741831&main=1&lang=0'
